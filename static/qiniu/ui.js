...
FileProgress.prototype.setChunkProgess = function(chunk_size) {
    ...
    if (!this.fileProgressWrapper.find('td:eq(2) .btn-default').length) {
        this.fileProgressWrapper.find('td>div');
    }
...
FileProgress.prototype.setComplete = function(up, info) {
    ...
    if (res.url) {
        url = res.url;
        str = "<input name=\"video_url\" id=\"video_url\" src=" +res.url+
            " autocomplete=\"off\" class=\"layui-input\" type=\"hidden\">"
            "<div><strong>Link:</strong><a href=" + res.url +
        ...
        str ="<input name=\"video_url\" id=\"video_url\" src=" +url+
            " autocomplete=\"off\" class=\"layui-input\" type=\"hidden\">"+
            "<div><strong>Link:</strong><a href=" + url + " target='_blank' > " +
            link + "</a></div>" +
            "<div class=hash><strong>Hash:</strong>" + res.hash + "</div>";
    }
